...
<style>
  ...
  .project {
    ...
    border-left: 2px solid color-mix(in oklch, var(--terminal-prompt) 35%, transparent);
  ...
  .tag {
    ...
    border-radius: 3px;
    background-color: color-mix(in oklch, var(--terminal-success) 12%, transparent);
    color: var(--terminal-success);
    border: 1px solid color-mix(in oklch, var(--terminal-success) 25%, transparent);
    font-weight: 600;
